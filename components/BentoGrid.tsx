            ...
            <div className="container mx-auto px-6 lg:px-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-6 auto-rows-[300px] md:auto-rows-[300px]">
                    ...
                    <BentoItem className="md:col-span-3 lg:col-span-4 row-span-2 bg-[#111]" delay={0.1}>
                        ...
                        <div className="h-full flex flex-col p-8 relative overflow-hidden z-10">
                            ...
                            <div className="mt-8 space-y-3 opacity-60 group-hover:opacity-100 transition-opacity duration-500">
                                <div /> Hands On Workshop by one of our cofounders
                                <div /> Review and Assistance on Startup Pitches
                            </div>
                    ...
                    <BentoItem className="md:col-span-3 lg:col-span-4 bg-gradient-to-br from-[#1a1a1a] to-black relative group overflow-hidden" delay={0.2}>
                        <div className="absolute inset-0">
                            <img
