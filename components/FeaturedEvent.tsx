  ...
  return (
    <motion.section initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="glass p-8 rounded-2xl border border-white/6 shadow-xl flex flex-col md:flex-row gap-6">
      ...
      <div className="flex-1">
        <h3 className="text-2xl font-semibold">Signature — The Skyscraper Hackathon</h3>
        <div className="text-gray-400 mt-2">June 12-14, 2026 • New York, NY</div>
        ...
        <div className="mt-6">
          <button className="px-6 py-3 rounded-md bg-white text-black">Register</button>
        </div>
      </div>
    </motion.section>
  )
