  ...
  return (
    <motion.section initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="glass p-8 rounded-2xl border border-white/6 shadow-xl flex flex-col md:flex-row gap-6">
      <div className="w-full md:w-1/3 h-40 rounded-lg overflow-hidden">
        <img src="/images/events/signature_hackathon.png" alt="Signature Hackathon" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
      </div>
